...
def make_single_inner_loop_update(optim_type, stepsize_type, omega,
    ...
    if stepsize_type == 'fixed_stepsize':
        ...
        while True:
            ...
            if ((optim_type == 'unconstrained' and J_tmp >= J_old + alpha * cm)
                or
