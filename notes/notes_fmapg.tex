...
\end{equation}
  ...
  \begin{IEEEeqnarray}{rCl}
    \mathcal{L}(p^\pi, \lambda_s, \lambda_{s, a}) &=& \sum_s d^{\pi_t}(s) \sum_a p^{\pi_t}(a|s) \left( Q^{\pi_t}(s, a) \frac{p^\pi(a | s)}{p^{\pi_t}(a | s)} - \frac{1}{\eta} \sum_a p^\pi(a | s) \log \frac{p^\pi(a | s)}{p^{\pi_t}(a | s)} \right) \nonumber \\
    && - \sum_{s, a} \lambda_{s, a} p^\pi(a | s) - \sum_s \lambda_{s} \bigg( \sum_a p^\pi(a | s) - 1 \bigg).
  \end{IEEEeqnarray}
  ...
  \begin{IEEEeqnarray}{lrCl}
    & \nabla_{p^\pi(b | x)} \mathcal{L}(p^\pi, \lambda_s, \lambda_{s, a}) &=& d^{\pi_t}(x) p^{\pi_t}(b|x) \left( \frac{Q^{\pi_t}(x, b)}{p^{\pi_t}(b | x)} - \frac{1}{\eta} \left[ \log \frac{p^\pi(b | x)}{p^{\pi_t}(b | x)} + 1 \right] \right) - \lambda_{x, b} - \lambda_x \nonumber \\
    &&=& d^{\pi_t}(x) p^{\pi_t}(b|x) \left( \frac{Q^{\pi_t}(x, b)}{p^{\pi_t}(b | x)} - \frac{1}{\eta} \left[ \log \frac{p^\pi(b | x)}{p^{\pi_t}(b | x)} + 1 \right] - \frac{\lambda_{x, b} + \lambda_x}{d^{\pi_t}(x) p^{\pi_t}(b|x)} \right) \nonumber \\
    &&=& 0 \nonumber \\
    \Rightarrow & \log \frac{p^\pi(b | x)}{p^{\pi_t}(b | x)} &=& \frac{\eta Q^{\pi_t}(x, b)}{p^{\pi_t}(b | x)} - \frac{\eta (\lambda_{x, b} + \lambda_x)}{d^{\pi_t}(x) p^{\pi_t}(b|x)} - 1 \nonumber \\
    \Rightarrow & p^\pi(b | x) &=& p^{\pi_t}(b | x) \cdot \exp \left(\frac{\eta Q^{\pi_t}(x, b)}{p^{\pi_t}(b | x)} \right) \cdot \exp \left(- \frac{\eta (\lambda_{x, b} + \lambda_x)}{d^{\pi_t}(x) p^{\pi_t}(b|x)} - 1 \right).
  \end{IEEEeqnarray}
