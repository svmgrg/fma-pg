...
#======================================================================
env_OLD = CliffWorld(
    P=P_OLD, r=r_OLD, mu=mu_OLD, terminal_states=terminal_states_OLD,
...
for state_idx in range(xlim * ylim):
    ...
    for action_idx in range(4):
        next_state_idx = env_OLD.P[state_idx, action_idx].nonzero()[0].item()
...
for env_try, col, env_name in \
    zip([env_OLD, env], range(2), ['OLD', 'smaller']):
